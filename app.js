        ...
        <div class="group relative bg-[#121214] rounded-xl border border-white/5 overflow-hidden transition-all duration-500 hover:border-brand-gold/30 hover:shadow-[0_10px_40px_rgba(212,175,55,0.1)] hover:-translate-y-2 flex flex-col h-full cursor-pointer" onclick="openModal(${project.id})">
            ...
            <div class="p-8 flex flex-col flex-grow relative">
                ...
                <div class="flex flex-col gap-2 mt-auto w-full">
                    <a href="tel:+18005551234" onclick="event.stopPropagation()"
                        class="w-full text-center py-3 bg-brand-gold/10 border border-brand-gold/50 text-brand-gold hover:bg-brand-gold hover:text-black uppercase tracking-widest text-[10px] font-bold rounded transition-all duration-300 flex justify-center items-center gap-2">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                        Call Us Now
                    </a>
                    <button class="w-full text-center py-3 bg-white/5 group-hover:bg-brand-gold text-white group-hover:text-black uppercase tracking-widest text-[10px] sm:text-xs font-bold rounded transition-all duration-300 border border-white/5 group-hover:border-brand-gold">
                        View Details & Photos
                    </button>
                </div>
            </div>
